# EKS CLUSTER ROLE
resource "aws_iam_role" "EKSNordCloudClusterRole" {
  name = "EKSNordCloudClusterRole"
...
resource "aws_iam_role_policy_attachment" "AmazonEKSNordCloudClusterPolicy" {
  policy_arn = "arn:aws:iam::aws:policy/AmazonEKSClusterPolicy"
  role       = aws_iam_role.EKSNordCloudClusterRole.name
}

# NODE GROUP ROLE
resource "aws_iam_role" "NordCloudNodeGroupRole" {
  name = "EKSNordCloudNodeGroupRole"
  assume_role_policy = jsonencode({
    Version = "2012-10-17"
    Statement = [
      {
...
resource "aws_iam_role_policy_attachment" "AmazonEKSNordCloudWorkerNodePolicy" {
  policy_arn = "arn:aws:iam::aws:policy/AmazonEKSWorkerNodePolicy"
  role       = aws_iam_role.NordCloudNodeGroupRole.name
}

// Provides read-only access to Amazon EC2 Container Registry repositories.
resource "aws_iam_role_policy_attachment" "AmazonNordCloudEC2ContainerRegistryReadOnly" {
...
resource "aws_iam_role_policy_attachment" "AmazonNordCloudEKS_CNI_Policy" {
